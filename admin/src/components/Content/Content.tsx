              ...
              <Tr key={index}>
                <Td>
                  <Field.Root
                    ...
                    hint="The identifier of your colleciton, e.g. api::article.article"
                  >
                    <Field.Input
                ...
                <Td>
                  <Field.Root
                    ...
                    hint="The fields you want to be searchable by the plugin"
                  >
                    <Field.Input
                      value={ct.fieldsRaw || ''}
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                ...
                <Td>
                  <Field.Root hint="Relations/components/media to load.">
                    <Field.Input
                      value={ct.populateFieldsRaw || ''}
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                        updatePopulateFields(index, e.target.value)
                      }
                      placeholder="Leave empty to populate all"
                    />
                    <Field.Hint />
                  </Field.Root>
                </Td>
